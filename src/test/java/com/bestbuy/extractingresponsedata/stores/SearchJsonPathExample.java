...
public class SearchJsonPathExample {
    ...
    public void test003() {
        ...
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The fifth store name is : " + fifthStoreName);
        System.out.println("------------------End of Test---------------------------");
    }
    ...
    public void test004() {
        ...
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The names of all stores are : " + allStoresNames);
        System.out.println("------------------End of Test---------------------------");
    ...
    @Test
    public void test005() {
        List<String> allStoresID = response.extract().path("data.id");
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The storeID of all stores : " + allStoresID);
        System.out.println("------------------End of Test---------------------------");
    }

    // 6) GPrint the size of the data list
    @Test
    public void test006() {
